...
class SearchAdapter(val homelist: ArrayList<Rumah>) :
    ...
    override fun onBindViewHolder(holder: SearchViewHolder, position: Int) {
        ...
        holder.view.btnDetail.setOnClickListener {
            val action=SearchFragmentDirections.actionItemSearchToDetailHomeListFragment(homelist[position].idRumah.toString())
