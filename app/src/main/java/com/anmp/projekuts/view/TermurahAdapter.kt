...
class TermurahAdapter(val homelist: ArrayList<Rumah>) :
    RecyclerView.Adapter<TermurahAdapter.TermurahViewHolder>() {
    class TermurahViewHolder(var view: View) : RecyclerView.ViewHolder(view)
    ...
    override fun onCreateViewHolder(
        ...
        return TermurahViewHolder(view)

    }

    override fun onBindViewHolder(holder: TermurahViewHolder, position: Int) {
